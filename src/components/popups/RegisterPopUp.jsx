      ...
      <div className="popup-box">
        <div className="box">
          {otherAccount ? (
            ...
            <div className="card">
              <div className="card-body">
                <h5 className="card-title2">Register</h5>
                <hr />
                <div>
                  <Box m={2}>
                  ...
                  <Box m={2}>
                    <FormControl className="custom-input-box">
                      ...
                      >
                        ...
                        <MenuItem value="/images/Avatar1.gif">
                          Female 1
                        </MenuItem>
                        ...
                        <MenuItem value="/images/Avatar2.gif">Male 1</MenuItem>
                        <MenuItem value="/images/Avatar4.png">Male 2</MenuItem>
                        <MenuItem value="/images/Avatar3.gif">Male 3</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  <Box m={2}>
